            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Deactivated Hospitals</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="adminPanel.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Deactivated Hospitals</li>
                        </ol>
                      
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Deactivated Hospitals
                            </div>
                            <div class="card-body">
                              ...
                              $query2="SELECT * FROM `hospital` WHERE status= 'deactivated'";
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-success" href="deactivatedHospitals_db.php?hos_id=<?php echo $h_id; ?>"> Activate </a>
