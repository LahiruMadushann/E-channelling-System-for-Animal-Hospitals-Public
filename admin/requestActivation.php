            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Hospitals requested for activation</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="adminPanel.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Request Activation</li>
                        </ol>
                      
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Hospitals requested for activation
                            </div>
                            <div class="card-body">
                            ...
                            $query = "SELECT * FROM hospital WHERE requestActivation ='yes' AND status='deactivated'";
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <a class="btn btn-success" href="requestActivation_db.php?hos_id=<?php echo $h_id; ?>"> Activate </a>
                              </td>
                              </tr>
                      <?php
                          }
