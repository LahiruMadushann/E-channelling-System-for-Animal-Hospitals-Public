                    ...
                    if ($password!=$password_again){
                        ...
                        if (mysqli_num_rows($query_run)==1){
                            echo 'The username '.$username.' already exists.';
                                    ...
                                    // $query2 = "INSERT INTO hospital (H_name, H_address, H_city,H_district,H_email,H_phoneNumber,Num_slotsPerDay,About_us,Facilities,image_main,status,requestActivation) values('$name','$address', '$city','$distric','$email','$phone','$slotsperday','$about','$facilities','$upload_images','notverified','no')";
