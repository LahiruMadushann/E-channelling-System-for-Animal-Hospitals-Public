      ...
      if (isset($_POST["areas"]) && count($_POST["areas"]) > 0) {
          ...
          foreach ($specialAreas as $specialArea) {
            ...
            //IF THE HOSPITAL DOES NOT EXITS IN THE SPECIALFACILITIES TABLE
              ...
              $query2 = "INSERT INTO specialfacilities VALUES ('".mysqli_real_escape_string($con,$hos_id)."','".mysqli_real_escape_string($con,$specialArea)."')";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-3 mb-5 shadow" style="width: 50%">
