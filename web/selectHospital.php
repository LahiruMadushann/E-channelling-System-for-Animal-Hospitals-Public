...
require '../core.php';
  ...
  //ASSIGNING THE SEARCHED DISTRICT TO THE VARIABLE
  $district=$_GET['H_district'];
...
<body>
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <form action="selectHospital.php?H_district=<?php echo $district; ?>" method="POST" style="width:100%">
    ...
    <section class="p-5 mt-4">
        ...
        if(empty($filteredHospitals)){
          $query="SELECT * FROM `hospital` WHERE `H_district` = '$district' AND status='activated'";
                          ...
                          <div class="row g-0">
                            ...
                            <div class="col-md-6">
                              <div class="card-body">
                                ...
                                <p class="card-text"><?php echo $row['H_address']; ?>
                                <p class="card-text"><?php echo $row['H_email']; ?></p>
                                <p class="card-text">0<?php echo $row['H_phoneNumber']; ?></p>
          ...
          foreach ($unique_array as $hos_id) {
            ...
            $query="SELECT * FROM `hospital` WHERE `H_district` = '$district' AND status='activated' AND Hospital_id=$hos_id";
