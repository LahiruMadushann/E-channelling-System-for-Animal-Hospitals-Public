...
<nav class="navbar navbar-expand-lg shadow">
            <div class="container mt-2 mb-2">
              <a class="navbar-brand" href="web/index.php"> <img src="./img/logo.png" alt="brand" width="50" height="43" > KodaVet</a>
...
<div class="container" style="height:3rem">
        ...
        <div class="container text-center mt-3">
            ...
            <a href="login_form.php" class="ms-3">Login</a>
                ...
                <!-- hospital register -->
           <div class="tab-pane fade container mt-3 mb-5 shadow" id="nav-hospital" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0" style="width:800px;">

                <form action="hosdisplay.php" method="POST" enctype="multipart/form-data" autocomplete="off" style="height:78vw;margin-top:-3.5vw">
                            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="ms-3" name="district">
        ...
        <div class="container" style="height:3rem">
          ...
          <section class="p-5 ">
            <div class="container border-top">
              ...
              <!-- <div class="bg-sqr"></div>
              <div class="bg-sqr sqr-sm"></div>
              <div class="bg-sqr" style="left:1230px;top:2200px;"></div>
              <div class="bg-sqr sqr-sm" style="left:1320px;top:2160px"></div> -->
            </div>
          </section>
